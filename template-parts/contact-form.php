<?php
// Get the company contact and social information
$social_links = yato_get_social_links();
?>
...
<div class="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
    <div class="flex flex-col md:flex-row">
        ...
        <div class="bg-gray-50 p-12 md:w-2/5">
            ...
            <?php if (!empty($social_links['address'])) : ?>
            <div class="flex items-start mb-10">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm"><?php echo nl2br(esc_html($social_links['address'])); ?></p>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="flex items-start mb-10">
                ...
                <div>
                    ...
                    <p class="text-gray-700"><?php echo esc_html($social_links['email']); ?></p>
                </div>
            </div>
            <?php endif; ?>
            
            <?php if (!empty($social_links['phone']) || !empty($social_links['whatsapp'])) : ?>
            <div class="flex items-start mb-10">
                <div class="bg-green-600 text-white p-3 rounded-full mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                    ...
                    <?php if (!empty($social_links['phone'])) : ?>
                        <p class="text-gray-700">Celular: +<?php echo esc_html($social_links['phone']); ?></p>
                    <?php endif; ?>
                    <?php if (!empty($social_links['whatsapp'])) : ?>
                        <p class="text-gray-700">Celular: +<?php echo esc_html($social_links['whatsapp']); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <?php endif; ?>
            ...
            <!-- Social Media Links -->
            <div class="mt-12">
                <h3 class="font-bold text-sm text-bg-primary mb-4 border-t-2 border-t-gray-200 pt-4">Sigue nuestras redes sociales</h3>
                <div class="flex space-x-3">
                    <?php if (!empty($social_links['facebook'])) : ?>
                        <a href="<?php echo esc_url($social_links['facebook']); ?>" target="_blank" class="bg-green-600 text-white p-2 rounded-full hover:bg-bg-primary transition-colors">
                    ...
                    <?php if (!empty($social_links['instagram'])) : ?>
                        <a href="<?php echo esc_url($social_links['instagram']); ?>" target="_blank" class="bg-green-600 text-white p-2 rounded-full hover:bg-bg-primary transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <!-- YouTube Icon -->
                    <a href="#" class="bg-green-600 text-white p-2 rounded-full hover:bg-bg-primary transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="p-12 md:w-3/5">
            ...
            <form id="contactForm" class="space-y-3" method="POST">
                ...
                <div>
                    <button type="submit" class="w-full bg-bg-primary text-white py-3 px-4 rounded-full hover:bg-bg-primary transition-colors font-medium">
                        Enviar
                    </button>
                </div>
            </form>
