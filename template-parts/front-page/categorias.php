          ...
          ?>
            <div class="swiper-slide">
              <a href="<?php echo get_term_link($category); ?>" class="block link"> <!-- Agregamos el enlace aquí -->
                  <div class="animation-card-bg-slider group bg-white rounded-lg flex flex-col h-full relative shadow-card p-8 cursor-pointer"> <!-- Agregamos cursor-pointer -->
                      <h3 class="z-10 text-bg-secondarysoft group-hover:text-white font-black text-2xl uppercase mb-8">
