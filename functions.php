        ...
        <form action="options.php" method="post">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="url" name="yato_social_facebook" value="<?php echo esc_attr(get_option('yato_social_facebook')); ?>" class="regular-text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">Instagram</th>
                    <td>
                        <input type="url" name="yato_social_instagram" value="<?php echo esc_attr(get_option('yato_social_instagram')); ?>" class="regular-text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">Teléfono</th>
                    <td>
                        <input type="tel" name="yato_contact_phone" value="<?php echo esc_attr(get_option('yato_contact_phone')); ?>" class="regular-text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">WhatsApp</th>
                    <td>
                        <input type="tel" name="yato_contact_whatsapp" value="<?php echo esc_attr(get_option('yato_contact_whatsapp')); ?>" class="regular-text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">Email</th>
                    <td>
                        <input type="email" name="yato_contact_email" value="<?php echo esc_attr(get_option('yato_contact_email')); ?>" class="regular-text">
                    </td>
                </tr>
                <tr>
                    <th scope="row">Dirección</th>
                    <td>
                        <textarea name="yato_contact_address" rows="3" class="regular-text"><?php echo esc_textarea(get_option('yato_contact_address')); ?></textarea>
                    </td>
                </tr>
            </table>
